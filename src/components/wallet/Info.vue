      ...
      <b-col>
        <b-row align-h="end" class="pt-1 pr-1">
          <b-dropdown no-caret right variant="outline-light">
            ...
            <b-dropdown-item-button>
              <vue-goodshare-whats-app style="width: 12rem" title_social="Enviar no Whats" has_icon/>
            </b-dropdown-item-button>
            <b-dropdown-item-button>
              <vue-goodshare-telegram style="width: 12rem" title_social="Enviar no Telegram" has_icon/>
            </b-dropdown-item-button>
            <b-dropdown-item-button>
              <vue-goodshare-twitter style="width: 12rem" title_social="Enviar no Twitter" has_icon/>
            </b-dropdown-item-button>
            <b-dropdown-item-button>
              <vue-goodshare-facebook style="width: 12rem" title_social="Enviar no Facebook" has_icon/>
            </b-dropdown-item-button>
          </b-dropdown>
        </b-row>
      </b-col>
