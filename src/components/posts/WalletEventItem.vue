...
<div>
  ...
  <b-row class="pt-3" v-if="starts.length > 0">
    <b-col cols="auto" style="width:6.3rem"  align-self="start" class="text-secondary">
      <b-row class="m-0 p-0"> Iniciou </b-row>
      <b-row class="m-0 p-0"> posição </b-row>
    </b-col>
    <b-col
      cols="auto"
      class="mr-2"
    ...
    >
      <b-row>
        <AssetIcon size="md" class="mr-1" showTitle :code="event.ticker" />
      </b-row>
    </b-col>
  ...
  <b-row class="pt-3 mb-2" v-if="ends.length > 0">
    <b-col cols="auto" style="width:6.3rem" align-self="start" class="text-secondary">
      <b-row class="m-0 p-0"> Encerrou </b-row>
      <b-row class="m-0 p-0"> posição </b-row>
    </b-col>
  ...
  <b-row class="pt-3" v-if="increases.length > 0">
    <b-col cols="auto" style="width:6.3rem"  align-self="start" class="text-secondary">
      <b-row class="m-0 p-0"> Aumentou </b-row>
      <b-row class="m-0 p-0"> posição </b-row>
    </b-col>
    <b-col
      cols="auto"
  ...
  <b-row class="pt-3 mb-2" v-if="decreases.length > 0">
    <b-col cols="auto" style="width:6.3rem" align-self="start" class="text-secondary">
      <b-row class="m-0 p-0"> Diminuiu </b-row>
      <b-row class="m-0 p-0"> posição </b-row>
    </b-col>
