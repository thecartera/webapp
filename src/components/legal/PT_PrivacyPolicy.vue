<template>
  ...
  <h4> 1. QUE INFORMAÇÕES RECOLHEMOS? </h4>
  ...
  <h4> 3. SUAS INFORMAÇÕES SERÃO COMPARTILHADAS COM ALGUEM? </h4>

  <p> Resumindo: só compartilhamos informações com o seu consentimento, para cumprir as leis, para lhe fornecer </p> serviços, para proteger seus direitos ou para cumprir obrigações comerciais.
  ...
  <h4> 4. COMO TRABALHAMOS SEUS LOGINS SOCIAIS? </h4>
  ...
  <h4> 5. POR QUANTO TEMPO MANTEMOS SUAS INFORMAÇÕES? </h4>
  ...
  <h4> 6. COMO MANTENHA SUAS INFORMAÇÕES SEGURAS? </h4>
  ...
  <h4> 7. QUAIS SÃO OS SEUS DIREITOS DE PRIVACIDADE? </h4>
  ...
  <h4> 8. CONTROLES PARA RECURSOS DE NÃO RASTREAR </h4>
  ...
  <h4> 9. OS RESIDENTES DA CALIFÓRNIA TÊM DIREITOS DE PRIVACIDADE ESPECÍFICOS? </h4>
  ...
  <h4> 10. FAZEMOS ATUALIZAÇÕES PARA ESTE AVISO? </h4>
